...
void eregtraining_7TeV_phiblind(bool dobarrel, bool doele) {
...
//   gSystem->Setenv("OMP_WAIT_POLICY","PASSIVE");
  ...
  TString dirname = "/data/bendavid/ereg7TeV_phiblind_Sept16_full/"; 
...
/*  TFile *fdinsig = TFile::Open("root://eoscms.cern.ch//eos/cms/store/cmst3/user/bendavid/trainingtreesJul1/hgg-2013Moriond_s12-h125gg-gf-v7a_noskim.root");
  ...
  if (doele) {
    ...
    tree->Add("/data/bendavid/regTrees_7TeV_Sep17/hgg-2013Final7TeV_reg_s11-zllm50-lv3_noskim.root");
...
//     tree->Add("root://eoscms.cern.ch//eos/cms/store/cmst3/user/bendavid/regTreesAug1/hgg-2013Final8TeV_reg_s12-pj40-2em-v7n_noskim.root");
    ...
    tree->Add("/data/bendavid/regTrees_7TeV_Sep17/hgg-2013Final7TeV_reg_s11-pj20-2em-lv3_noskim.root");
