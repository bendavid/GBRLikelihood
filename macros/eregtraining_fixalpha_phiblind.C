...
void eregtraining_fixalpha_phiblind(bool dobarrel, bool doele) {
...
//   gSystem->Setenv("OMP_WAIT_POLICY","PASSIVE");
  ...
  TString dirname = "/afs/cern.ch/work/b/bendavid/bare/eregAug10RCalphafixphiblind/"; 
  ...
  varseb->push_back("ph.iphiseed%18");
...
//   varsee->push_back("ph.ixseed%5");
//   varsee->push_back("ph.iyseed%5");
