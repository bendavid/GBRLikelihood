...
class RooDoubleCBSlow : public RooAbsPdf {
public:
  RooDoubleCBSlow();
  RooDoubleCBSlow(const char *name, const char *title,
	      RooAbsReal& _x,
	      RooAbsReal& _mean,
	      RooAbsReal& _width,
	      RooAbsReal& _alpha1,
  ...
  RooDoubleCBSlow(const RooDoubleCBSlow& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new RooDoubleCBSlow(*this,newname); }
  inline virtual ~RooDoubleCBSlow() { }
  Int_t getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* rangeName=0) const ;
  Double_t analyticalIntegral(Int_t code, const char* rangeName=0) const ;
